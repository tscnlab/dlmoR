...
If you use `dlmoR` in your research, please cite the following preprint, which describes the package and its implementation:  

Thalji, S. M., & Spitschan, M. (2025). *dlmoR: An open-source R package for the dim-light melatonin onset (DLMO) hockey-stick method.* [bioRxiv, 2025-01](https://doi.org/10.1101/2025.01.13.632603).
