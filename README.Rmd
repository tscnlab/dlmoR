...
- **Coarse- and fine-grid DLMO search (`fine_flag = TRUE`, default)**: ~10 minutes per melatonin profile.  
- **Coarse-grid DLMO search only (`fine_flag = FALSE`)**: ~1 minute per melatonin profile.  
