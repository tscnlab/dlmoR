...
# plot is in plot_profile
# library(ggplot2)
#
# # Plotting function
# plot_with_parallelogram <- function(profile_data, trunc_result) {
#   # Filter for the ascending segment
...
#
#   # Get y0 and y1 from the ascending segment
...
# print('parallelogram df')
# print(parallelogram_df)
#   # Plot the melatonin profile
#   ggplot(profile_data, aes(x = datetime, y = melatonin)) +
#     geom_line(color = "blue") +  # Full melatonin profile
#     geom_polygon(data = parallelogram_df, aes(x = datetime, y = melatonin),
#                  fill = "red", alpha = 0.3) +  # Parallelogram
#     labs(title = "Melatonin Profile with Optimized Parallelogram",
#          x = "Datetime", y = "Melatonin") +
#     theme_minimal()
# }

# Example usage:
# Assuming `profile_data` is your tibble and `trunc_result` is the output from `parallelogram_truncation()`
# plot_with_parallelogram(profile_data, trunc_result)
